  ...
  const plans = [
    {
      ...
      price: '$0',
      period: 'forever',
      description: 'Perfect for a first look at your ATS score',
      icon: Sparkles,
      features: [
        'ATS score demo — no login needed',
        '1 full resume analysis',
        'ATS score with qualitative label',
        'Numbered improvement checklist',
    ...
    },
    {
      ...
      features: [
        ...
        'Job-specific optimization (match any job posting)',
        'Keyword matched vs. missing breakdown',
        'LinkedIn section generator (Headline, About, Experience)',
        'Full Kanban application pipeline',
        'AI coach per application stage',
        'Interview & follow-up log',
